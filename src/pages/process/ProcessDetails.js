...
class ProcessDetails extends Component<ProcessDetailsProps, ProcessDetailsState> {
                ...
                <Row>
                  ...
                  <Col lg={7}>
                    <form className="pl-lg-4">
                      ...
                      <div className="mt-3">
                        <h4>
                          <span className="badge badge-success-lighten">{this.state.product.status}</span>
                        </h4>
                      </div>
                      ...
                      <div className="mt-4">
                        <div className="row">
                          ...
                          <div className="col-md-4">
                            ...
                            <p className="text-sm lh-150">{this.state.product.noOfOrders}</p>
                          </div>
                          <div className="col-md-4">
