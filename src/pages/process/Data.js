import {
    PROCESS_TYPE_SEARCHYELP,
    PROCESS_TYPE_SCRAPEYELP,
    PROCESS_TYPE_VALIDEMAIL,
    PROCESS_TYPE_WOODIMPORT,
    PROCESS_TYPES,
...
const processes = [
    {
        id: 1,
        name: 'Search Engineering in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_SEARCHYELP],
        added_date: '2/12/2020',
        status: PROCESS_STATUS_COMPLETED
    },
    {
        id: 2,
        name: 'Search Restaurants in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_SEARCHYELP],
        added_date: '2/13/2020',
        status: PROCESS_STATUS_COMPLETED
    },
    {
        id: 3,
        name: 'Search Attorneys in California',
        type: PROCESS_TYPES[PROCESS_TYPE_SEARCHYELP],
        added_date: '2/14/2020',
        status: PROCESS_STATUS_SCHEDULED,
    },
    {
        id: 4,
        name: 'Scrape Engineering in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_SCRAPEYELP],
        added_date: '2/13/2020',
        status: PROCESS_STATUS_RUNNING,
    },
    {
        id: 5,
        name: 'Scrape Restaurants in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_SCRAPEYELP],
        added_date: '2/13/2020',
    ...
    {
        id: 6,
        name: 'Scrape Attorneys in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_SCRAPEYELP],
        added_date: '2/15/2020',
        status: PROCESS_STATUS_SCHEDULED,
    },
    {
        id: 7,
        name: 'Validate Emails of Restaurants in New York',
        type: PROCESS_TYPES[PROCESS_TYPE_VALIDEMAIL],
        added_date: '2/13/2020',
        status: PROCESS_STATUS_CANCELED,
    },
    {
        id: 8,
        name: 'Validate Emails of Engineering in Texas',
        type: PROCESS_TYPES[PROCESS_TYPE_VALIDEMAIL],
        added_date: '2/14/2020',
        status: PROCESS_STATUS_COMPLETED,
    },
    {
        id: 9,
        name: 'Campaign for Attorneys',
        type: PROCESS_TYPES[PROCESS_TYPE_WOODIMPORT],
        added_date: '2/14/2020',
        status: PROCESS_STATUS_SCHEDULED,
    },
    {
        id: 10,
        name: 'Campaign for Restaurants',
        type: PROCESS_TYPES[PROCESS_TYPE_WOODIMPORT],
        added_date: '2/13/2020',
...
export { processes, orders, customers, sellers };
