...
const Balances = () => {
  ...
  const BalanceColumn = (cell, row, rowIndex, extraData) => {
    return (
      <React.Fragment>
  ...
  const BalanceDateColumn = (cell, row, rowIndex, extraData) => {
    return (
      <React.Fragment>
        ...
        <Col>
          <Card>
            <CardBody>
              ...
              <BalanceTable data={orders} columns={columns} paginationOptions={paginationOptions} />
            </CardBody>
          </Card>
        </Col>
      </Row>
